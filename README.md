...
A curated list for awesome GitOps resources inspired by [@sindresorhus' awesome](https://github.com/sindresorhus/awesome) ⭐ 496,304 | 🐛 100 | 📅 2026-06-30
...
* [ArgoCD](https://github.com/argoproj/argo-cd) ⭐ 23,928 | 🐛 4,353 | 🌐 Go | 📅 2026-08-16 - Declarative continuous deployment for Kubernetes
* [Flux](https://github.com/fluxcd/flux2) ⭐ 8,334 | 🐛 250 | 🌐 Go | 📅 2026-08-09 - Open and extensible continuous delivery solution for Kubernetes. Powered by GitOps Toolkit
* [Flagger](https://github.com/weaveworks/flagger) ⭐ 5,388 | 🐛 383 | 🌐 Go | 📅 2026-08-11 - Progressive delivery Kubernetes operator (Canary, A/B testing and Blue/Green deployments automation)
* [Ignite](https://github.com/weaveworks/ignite) ⚠️ Archived - A Virtual Machine manager with a container UX and built-in GitOps
* [Kubefirst](https://github.com/kubefirst/kubefirst) ⭐ 2,056 | 🐛 289 | 🌐 Go | 📅 2026-02-25 - Fully-automated OSS delivery & infrastructure management gitops platforms
...
* [Weave GitOps OSS](https://github.com/weaveworks/weave-gitops) ⭐ 1,126 | 🐛 162 | 🌐 MDX | 📅 2026-08-15 - Weave GitOps is a simple open source developer platform for people who want cloud native applications, without needing Kubernetes expertise.
* [Helm Operator](https://github.com/fluxcd/helm-operator) ⚠️ Archived - Automates Helm Chart releases in a GitOps manner
* [Proxmox-GitOps](https://github.com/stevius10/Proxmox-GitOps) ⭐ 565 | 🐛 1 | 🌐 Ruby | 📅 2026-07-18 - Self-contained GitOps framework for LXC-based container automation on Proxmox VE.
* [Gimlet](https://github.com/gimlet-io/gimlet) ⚠️ Archived - The Flux-based Internal Developer Platform
* [Autoapply](https://github.com/autoapply/autoapply) ⭐ 157 | 🐛 12 | 🌐 JavaScript | 📅 2025-11-14 - Automatically apply changes from a Git repository to a Kubernetes cluster
...
* [SOPS](https://github.com/mozilla/sops) ⭐ 22,829 | 🐛 438 | 🌐 Go | 📅 2026-08-10 - Secrets OPerationS
* [Sealed Secrets](https://github.com/bitnami-labs/sealed-secrets) ⭐ 9,246 | 🐛 73 | 🌐 Go | 📅 2026-08-11 - One-way encrypted Secrets
...
* [Managing Helm releases the GitOps way](https://github.com/fluxcd/flux2-kustomize-helm-example) ⭐ 1,289 | 🐛 0 | 🌐 Shell | 📅 2026-07-08 - Flux and Helm Operator tutorial
* [Automating Istio canary deployments with GitOps](https://github.com/stefanprodan/gitops-istio) ⭐ 669 | 🐛 3 | 📅 2026-05-19 - Progressive Delivery tutorial with Flagger, Flux, Helm Operator and Istio
