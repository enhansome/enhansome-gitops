...
A curated list for awesome GitOps resources inspired by [@sindresorhus' awesome](https://github.com/sindresorhus/awesome) ⭐ 505,029 | 🐛 106 | 📅 2026-09-02
...
* [ArgoCD](https://github.com/argoproj/argo-cd) ⭐ 24,128 | 🐛 4,367 | 🌐 Go | 📅 2026-09-11 - Declarative continuous deployment for Kubernetes
* [Flux](https://github.com/fluxcd/flux2) ⭐ 8,394 | 🐛 258 | 🌐 Go | 📅 2026-09-11 - Open and extensible continuous delivery solution for Kubernetes. Powered by GitOps Toolkit
...
* [Weave GitOps OSS](https://github.com/weaveworks/weave-gitops) ⭐ 1,130 | 🐛 162 | 🌐 MDX | 📅 2026-09-11 - Weave GitOps is a simple open source developer platform for people who want cloud native applications, without needing Kubernetes expertise.
* [Helm Operator](https://github.com/fluxcd/helm-operator) ⚠️ Archived - Automates Helm Chart releases in a GitOps manner
* [Proxmox-GitOps](https://github.com/stevius10/Proxmox-GitOps) ⭐ 582 | 🐛 0 | 🌐 Ruby | 📅 2026-08-30 - Self-contained GitOps framework for LXC-based container automation on Proxmox VE.
...
* [SOPS](https://github.com/mozilla/sops) ⭐ 23,088 | 🐛 446 | 🌐 Go | 📅 2026-09-07 - Secrets OPerationS
* [Sealed Secrets](https://github.com/bitnami-labs/sealed-secrets) ⭐ 9,287 | 🐛 66 | 🌐 Go | 📅 2026-09-10 - One-way encrypted Secrets
