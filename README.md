...
A curated list for awesome GitOps resources inspired by [@sindresorhus' awesome](https://github.com/sindresorhus/awesome) ⭐ 497,990 | 🐛 105 | 📅 2026-08-18
...
* [ArgoCD](https://github.com/argoproj/argo-cd) ⭐ 23,960 | 🐛 4,381 | 🌐 Go | 📅 2026-08-20 - Declarative continuous deployment for Kubernetes
* [Flux](https://github.com/fluxcd/flux2) ⭐ 8,357 | 🐛 250 | 🌐 Go | 📅 2026-08-09 - Open and extensible continuous delivery solution for Kubernetes. Powered by GitOps Toolkit
...
* [Weave GitOps OSS](https://github.com/weaveworks/weave-gitops) ⭐ 1,126 | 🐛 162 | 🌐 MDX | 📅 2026-08-19 - Weave GitOps is a simple open source developer platform for people who want cloud native applications, without needing Kubernetes expertise.
...
* [SOPS](https://github.com/mozilla/sops) ⭐ 22,866 | 🐛 439 | 🌐 Go | 📅 2026-08-17 - Secrets OPerationS
* [Sealed Secrets](https://github.com/bitnami-labs/sealed-secrets) ⭐ 9,251 | 🐛 68 | 🌐 Go | 📅 2026-08-20 - One-way encrypted Secrets
...
* [Managing Helm releases the GitOps way](https://github.com/fluxcd/flux2-kustomize-helm-example) ⭐ 1,290 | 🐛 0 | 🌐 Shell | 📅 2026-07-08 - Flux and Helm Operator tutorial
